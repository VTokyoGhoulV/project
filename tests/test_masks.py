...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("378282246310005", "3782 82** ***0 005"),
        ("30000000000004", "3000 00** **00 04"),
        ("6011000000000004", "6011 00** **** 0004"),
        ("6759411100000008", "6759 41** **** 0008"),
        ("586824160825533338", "5868 24** **** **33 38"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("4081781010000000000", "**0000"),
        ("408178101000000000000", "**0000"),
